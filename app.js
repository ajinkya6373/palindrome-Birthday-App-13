...
//     const allFormats = getAllFormats(date);
//     let flag = false;
...
//     while (true) {
//       ctr++;
//       const resultList = checkPalindromeForAll(nextDate);
...
//     while (true) {
//       ctr++;
//       const resultList = checkPalindromeForAll(previousDate);
...
//     const birthdayStr = Input.value; //2022-08-05
//     if (birthdayStr !== '') {
//         const dateList = birthdayStr.split('-');
//         const date = {
...
//         const isPalindrome = checkPalindromeForAll(date);
//         if (isPalindrome) {
//              Output.innerText = 'Yay! your birthday is a palindrome!! 🥳🥳';
//         }
//         else{
//           Output.innerText = 'so sad';
//             // const [count1 ,nextDate] = getNextPalindromeDate(date);
//             // const [count2 , prevDate] = getPreviousPalindromeDate(date);
//             // console.log(count1,nextDate);
//             // console.log(count2,prevDate);
//             // if(count1>count2){
...
//         }
//     }else{
//         Output.innerText = "Please input your Birthday "
//     }
// }
...
showBtn.addEventListener("click", ()=>{
  resultDiv.innerText = " we are doing calculation please wait 😄";
